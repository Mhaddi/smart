                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      Add content to the page ...
                       <form action="<?php echo base_url() ?>dashboard/page_insert" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="heading" id="heading" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control ckeditor" name="discription" rows="6"></textarea>
                        </div>
                      </div>
                    <div class="form-group">
                       <div class="col-sm-9 col-sm-offset-3 col-lg-10"><img src="<?php echo base_url() ?>admin_assets/images/user.png" width="100" height="100" id="pro" class="pro_img"></div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="ppic" id="imgInp" required="required" class="col-md-7 col-xs-12">
