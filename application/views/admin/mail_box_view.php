              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="<?php echo base_url() ?>admin/mail_box_insert" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate>

                       <div class="form-group">
                        
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">To :</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="to" class="select2_multiple form-control" multiple="multiple">
                          ...
                          <br>
                          <button type="button" class="btn btn-round btn-primary">All</button>
                          <button type="button" class="btn btn-round btn-danger">None</button>
                        <br><br><br><br></div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="subject" class="form-control" placeholder="Default Input" type="text"> <br><br><br>
                        </div>
                      </div>
